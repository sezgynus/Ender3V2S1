...
#define STRING_CONFIG_H_AUTHOR "OpenEYE 3D" // Who made the changes.
...
#define PIDTEMPBED  // Ender Configs
  ...
  #define DEFAULT_bedKp 109.98
  #define DEFAULT_bedKi  19.64
  #define DEFAULT_bedKd 410.58
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 101.8 }  // Ender Configs
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2  // MRiscoC allows higher limits
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 99999, 99999, 9999, 99999 } // ...or, set your own edit limits  // MRiscoC allows higher limits
#endif
...
#define CLASSIC_JERK  // Ender Configs
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2  // Ender Configs
    ...
    #define MAX_JERK_EDIT_VALUES { 20000000, 20000000, 1000000, 20000000} // ...or, set your own edit limits  // MRiscoC allows higher limits
  #endif
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -39.5, -20, -0.10 }  // MRiscoC BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)
...
#define FILAMENT_RUNOUT_SENSOR  // MRiscoC Enabled runout sensor support
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 220  // MRiscoC Customizable by menu
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (20*60) }  // MRiscoC Homing speed-up
